...
namespace Jedzia.BackBock.ViewModel.Data.Hierarchical
{
    ...
    /// <summary>
    /// The summary of RandaleViewModel. BaseType: 
    /// </summary>
    public partial class RandaleViewModel : ViewModelBase
    {
        internal Randale randale;

        public RandaleViewModel(Randale randale)
        {
            this.randale = randale;
        }
        ...
        public System.String Name
        {
            get
            {
                return this.randale.Name;
            }

            set
            {
                if (this.randale.Name == value)
                {
                    return;
                }
                this.randale.Name = value;
        ...
        public RandaleViewModel Clone()
        {
            return (RandaleViewModel)this.MemberwiseClone();
        }
    } 
}
