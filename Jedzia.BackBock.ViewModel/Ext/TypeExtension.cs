...
namespace Jedzia.BackBock.ViewModel.Ext
{
    ...
    public class TypeExtension : MarkupExtension
    {
        ...
        internal class SR
        {
            public const string TypeExtension_TypeOrNameMissing = "Must specify Type or TypeName.";
            public const string TypeExtension_ArgumentsWrongOrder = "Type arguments need to be specified in the right order.";
            public const string TypeExtension_NoIXamlTypeResolver = "Cannot retrieve IXamlTypeResolver.";
            public const string TypeExtension_InvalidTypeNameArgumentCount = "Invalid type argument count in type name.";
            public const string TypeExtension_InvalidTypeName = "Invalid type name.";
            public const string TypeExtension_InvalidTypeArgumentCount = "Invalid type argument count in type.";
            public const string TypeExtension_InvalidTypeNameArgumentCount3 = "Must specify Type or TypeName.";
        }
        #region Fields
        ...
        public TypeExtension(string typeName, Type typeArgument1)
            : this(typeName)
        {
            Guard.NotNull(() => typeArgument1, typeArgument1);
        ...
        {
            Guard.NotNull(() => typeArgument2, typeArgument2);
        ...
        {
            Guard.NotNull(() => typeArgument3, typeArgument3);
        ...
        {
            Guard.NotNull(() => typeArgument4, typeArgument4);
